...
public class MainClass { private static final int SIZE = 10000000;
    ...
    public void runOneThread() {
        ...
        calculate(arr);
        System.out.println("Метод с одним потоком заканчивается: " + (System.currentTimeMillis() - a));
    }
    ...
    public void runTwoThreads() {
        ...
        System.out.println("Два потока заканчивается: " + (System.currentTimeMillis() - a));
    }
